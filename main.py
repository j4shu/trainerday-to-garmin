...
def upload_garmin_activity(client: Garmin) -> None:
    ...
    # FIT carries no activity name. A workout message with wkt_name does not work
    # either: Garmin ignores it on upload and titles the activity "Virtual Cycling".
    # So the name has to be set over the API, after the upload is indexed.
